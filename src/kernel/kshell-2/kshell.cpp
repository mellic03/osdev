...
void kshell_main( void* )
{
    ...
    auto *win = sde::createWindow(ivec2(10, 10), ivec2(400, 400));
    win->m_style = {
        .fill = true,
        .border = 4,
    ...
    auto *win2 = sde::createWindow(ivec2(10, 10), ivec2(200, 150));
    win2->m_style = {
        .fill = true,
        .border = 8,
        .fill_color = vec4(0.0, 0.8, 1.0, 1.0),
        .border_color = vec4(0.2, 0.2, 0.2, 1.0)
    };

    auto *ttyframe = new sde::TerminalFrame(10, 10, 380, 380, &tty);
    ttyframe->m_style = {
        .fill = true,
        .border = 4,
    ...
    auto *button = new sde::Button(50, 380-30, 30, 30);
