...
//     elf64_section_header_t *elf_section_headers,
//     size_t section_count,
//     char *section_strtab)
// {
//     std::printf("IND |                 MAME |     TYPE | FLAG | OFFSET |   SIZE | ADDRESS          |\n");
//     std::printf("----+----------------------+----------+------+--------+--------+------------------+\n");
//     for (size_t index = 0; index < section_count; index++) {
//         elf64_section_header_t *section = (elf_section_headers + index);
//         char *name = (section_strtab + section->name_index);

//         std::printf("%3zu | ", index);
//         std::printf("%20s | ", name);
//         std::printf("%8s | ", ELF_SECTION_TYPE[section->type]);
//         std::printf("%c%c%c%c | ",
...
//             (section->flags & ~0x7) ? '?' : ' '
//         );
//         std::printf("%6llx | ", section->offset);
//         std::printf("%6llx | ", section->size);
//         std::printf("%.16llx | ", section->address);
//         std::printf("\n");
//     }
// }
